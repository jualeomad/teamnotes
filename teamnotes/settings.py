"""
Django settings for teamnotes project.
...
ALLOWED_HOSTS = ['teamnotes.onrender.com'] if DEBUG else ['teamnotes.onrender.com']
if not DEBUG:
...
WSGI_APPLICATION = 'teamnotes.wsgi.application'
